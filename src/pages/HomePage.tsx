...
function HomePage() {
  return (
    <div className="space-y-16">
      <section className="grid gap-6 rounded-3xl border border-brand-blue/15 bg-white p-8 shadow-card lg:grid-cols-2">
        <div className="space-y-5">
          ...
          <p className="text-lg leading-relaxed text-neutral-700">
            ...
            actionable insights. Explore our launch products and discover how Gamecam fits into your club roadmap.
          </p>
          <div className="flex flex-wrap gap-3">
            ...
            <Link
              to="/support"
              className="inline-flex items-center justify-center rounded-full border border-brand-blue/10 bg-brand-blue px-6 py-3 text-sm font-semibold text-white transition hover:bg-brand-pink"
            >
              Talk to our team
            </Link>
          </div>
